...
public class ProductCategoryArrayTypeTest {
    ...
    @Test
    public void ProductCategoryArrayType_AssertThrowsNotImplementedException()
            throws SQLException {
        ...
        Assertions.assertThrows(NotImplementedException.class,
                                () -> productCategoryArrayType.nullSafeSet(null, null, 0, null));
        ...
        Assertions.assertThrows(NotImplementedException.class,
                                () -> productCategoryArrayType.replace(null, null, null));
    }

    @Test
    public void ProductCategoryArrayType_sqlTypes_IsArray()
            throws SQLException {
        var productCategoryArrayType = new ProductCategoryArrayType();
    ...
    @Test
    public void ProductCategoryArrayType_isMutable_IsFalse()
            throws SQLException {
        var productCategoryArrayType = new ProductCategoryArrayType();
    ...
    @Test
    public void ProductCategoryArrayType_nullSafeGet_MapsCorrectlyRetrievedTextProductCategoryEnum()
            throws SQLException {
        var productCategoryArrayType = new ProductCategoryArrayType();
        ...
        Assertions.assertEquals(ProductCategoryEnum.LEARNING,
                                productCategoryArrayType.nullSafeGet(resultSet,
                                                                     new String[]{"any_name"},
                                                                     null,
                                                                     null)[0]);
    }
    ...
    @Test
    public void ProductCategoryArrayType_nullSafeGet_ThrowsForUnexpectedTextProductCategoryEnum()
            throws SQLException {
        var productCategoryArrayType = new ProductCategoryArrayType();
    ...
    @Test
    public void ProductCategoryArrayType_nullSafeGet_MapsCorrectlyANullProductCategoryEnum()
            throws SQLException {
        var productCategoryArrayType = new ProductCategoryArrayType();

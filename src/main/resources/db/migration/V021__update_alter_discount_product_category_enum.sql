...
SET product_category = 'ENTERTAINMENT'
WHERE product_category = 'ENTERTAINMENTS';
UPDATE discount_product_category
SET product_category = 'TRAVELLING'
WHERE product_category IN ('TRAVELS', 'TRANSPORTATION');
UPDATE discount_product_category
SET product_category = 'SERVICES'
WHERE product_category = 'CONNECTIVITY';
UPDATE discount_product_category
SET product_category = 'LEARNING'
WHERE product_category IN ('BOOKS', 'ARTS');

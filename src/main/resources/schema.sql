...
DROP SEQUENCE IF EXISTS REFERENT_SEQ;
...
CREATE TABLE REFERENT (
    ...
    CONSTRAINT REFERENT_PROFILE_FK FOREIGN KEY (PROFILE_FK) REFERENCES PROFILE(PROFILE_K)
);
CREATE SEQUENCE REFERENT_SEQ START WITH 1 INCREMENT BY 1;
CREATE UNIQUE INDEX IDX_REFERENT_PROFILE_FK ON REFERENT(PROFILE_FK);
...
CREATE TABLE ADDRESS (
    ...
    DISTRICT                  VARCHAR(2) NOT NULL, --sigla
    LATITUDE                  DOUBLE,
    LONGITUDE                 DOUBLE,
    PROFILE_FK                    BIGINT NOT NULL,
    INSERT_DATE                    TIME DEFAULT SYSDATE NOT NULL,

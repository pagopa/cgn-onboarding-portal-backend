...
@Component
public class ReferentConverter
        extends AbstractConverter<ReferentEntity, Referent> {

    protected Function<ReferentEntity, Referent> toDto = entity -> {
    ...
    protected Function<Referent, ReferentEntity> toEntity = dto -> {

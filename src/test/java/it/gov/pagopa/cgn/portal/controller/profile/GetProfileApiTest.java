...
class GetProfileApiTest
    ...
    @Test
    void Get_GetProfileWithInvalidAgreementId_Forbidden()
            throws Exception {
    ...
    void Get_GetProfile_Ok()
        ...
        this.mockMvc.perform(get(profilePath).contentType(MediaType.APPLICATION_JSON))
                    ...
                    .andExpect(jsonPath("$.referent.telephoneNumber").value(profileEntity.getReferent()
                                                                                         .getTelephoneNumber()))
